...
<p>
Nect, open Server Manager and select "Add roles and features". Under Server Roles, select "Windows Server Update Services" and continue steps for the configuration wizard.
</p>
<br />
